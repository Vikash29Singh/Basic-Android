...
public class BatCategory extends AppCompatActivity/* implements RecyclerViewAdapter.ClickAdapterListener*/{
    ...
    */private ActionMode actionMode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bat_category);
       ...
       getSupportActionBar().setDisplayShowHomeEnabled(true);
        ...
        btn_favorites.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                btn_favorites.setBackgroundDrawable(getResources().getDrawable(R.drawable.ic_favorite_black_24dp));
            }
        });*/
        /*try {*/
...
*/
    ...
    private void toggleSelection(int position) {
        ...
        if (count == 0) {
            ...
            actionMode.setName(String.valueOf(count));
...
*/
    private void populateDataAndSetAdapter() {
        ...
        Model model = new Model("ELEVAR", "Tennis Green", "Rs. 472", R.drawable.gully_bat, R.drawable.ic_favorite_border_black_24dp);
        dataModel.add(model);

        model = new Model("ICON", "Tennis Red", "Rs. 546", R.drawable.gully_bat2, R.drawable.ic_favorite_border_black_24dp);
        dataModel.add(model);

        model = new Model("MRF", "Deuce", "1461", R.drawable.deuce_bat, R.drawable.ic_favorite_border_black_24dp);
        dataModel.add(model);

        model = new Model("GM", "Deuce", "Rs. 848", R.drawable.deuce_bat3, R.drawable.ic_favorite_border_black_24dp);
        dataModel.add(model);

        model = new Model("Super Series", "Deuce", "Rs. 653", R.drawable.deuce_bat2, R.drawable.ic_favorite_border_black_24dp);
        dataModel.add(model);
        model = new Model("New Balance", "Deuce", "Rs. 1053", R.drawable.redtennis_bat , R.drawable.ic_favorite_border_black_24dp);
        dataModel.add(model);
