...
public class Train_book extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.train_book, container, false);
        ...
        travclass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mydialog.setContentView(R.layout.traveller_class_pop_train);
        ...
        travellertype.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Dialog mydialog = new Dialog(getActivity());
                mydialog.setContentView(R.layout.traveller_pop_train);
                mydialog.setCancelable(true);
                mydialog.show();
            }
        });
